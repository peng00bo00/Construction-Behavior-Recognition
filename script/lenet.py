...
def train(params, args):
    ...
    tensorboard = tf.keras.callbacks.TensorBoard(log_dir="../TensorBoard/lenet")
    checkpoint = tf.keras.callbacks.ModelCheckpoint("../checkpoints/lenet.hdf5", save_best_only=True)
