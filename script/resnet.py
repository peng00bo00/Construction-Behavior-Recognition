...
def train(params, args):
    ...
    tensorboard = tf.keras.callbacks.TensorBoard(log_dir="../TensorBoard/resnet")
    checkpoint = tf.keras.callbacks.ModelCheckpoint("../checkpoints/resnet.hdf5", save_best_only=True)
